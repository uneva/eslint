...
export type OptionsJavaScript = FlatConfigIsIneditor & FlatConfigOverrides;

export function javascript(options: OptionsJavaScript = {}): Linter.FlatConfig[] {
    const {
        isInEditor = false,
        overrides = {},
    } = options;
